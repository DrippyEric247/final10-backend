...
const betaCommunityRoutes = require('./routes/betaCommunityFeedback');
...
try {
  ...
  verifySavvyPredictionsHandlers({ failOnError: false });
  console.log('[startup] boot phase=savvy_predictions_handlers_ok');
} catch (spErr) {
...
app.use('/api/listings', require('./routes/listingRankingRoutes'));
