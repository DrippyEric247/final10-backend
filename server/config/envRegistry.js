...
const SERVER_ENV_REGISTRY = [
  ...
  { name: 'ALLOWED_ORIGINS', scope: 'server', requirement: 'optional', secret: false, prod: true, consumer: 'cors', failure: 'Uses built-in final10.app + Final10 Vercel preview prefix allowlist' },
  { name: 'VERCEL_PREVIEW_ORIGIN_PREFIXES', scope: 'server', requirement: 'optional', secret: false, prod: true, consumer: 'cors', failure: 'Defaults to final10-client Vercel preview hostnames only' },
