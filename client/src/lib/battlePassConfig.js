 ...
 *
 * Beta upgrade: 60 tiers, two tracks, rewards wired to the Final10 ecosystem
 * (Savvy, Eggs, Perk Machine spins/tokens, Streak Shields, Calling Cards,
 * cosmetics, soundtracks). Tier rewards are claimed manually (server-authoritative).
...
export const BATTLE_PASS_SEASON = {
  id: "neon_hunt_s1",
  name: "Neon Hunt",
  subtitle: "Season 1 · Beta · 60 tiers",
 ...
 * @property {'savvy'|'egg'|'free_spin'|'streak_shield'|'token'|'calling_card'|'cosmetic'|'mythic_chance'|'soundtrack'} type
 */
...
export const BATTLE_PASS_MILESTONES = [10, 15, 20, 25, 30, 40, 50, 60];
