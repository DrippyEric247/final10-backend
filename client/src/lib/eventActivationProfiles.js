...
export const EVENT_ACTIVATION_PROFILES = Object.freeze({
  ...
  triple_points: {
    ...
    audioFallbackMs: 4800,
    vibrationPattern: [55, 35, 90, 40, 110],
  },
  savvy_sale: {
    eventKey: 'savvy_sale',
    audioKey: 'savvy_sale',
    theme: 'red',
    color: '#fb923c',
    glowColor: 'rgba(239, 68, 68, 0.72)',
    glowSecondary: 'rgba(252, 211, 77, 0.48)',
    particleClass: 'red',
    particleEffect: 'sale_sparkle',
    impactAnimation: 'flare',
    glowIntensity: 'sale',
    rarity: 'limited',
    headline: '🔥 SAVVY SALE ACTIVE',
    idleCta: 'Tap to Activate',
    activatedTitle: 'Savvy Sale Activated',
    activatedMessage: 'Your Savvy goes further during this event.',
    audioFallbackMs: 4500,
    vibrationPattern: [40, 28, 65, 25, 55],
  },
  max_supply_drop: {
    ...
    glowSecondary: 'rgba(252, 211, 77, 0.38)',
    particleClass: 'blue',
    particleEffect: 'crate_drop',
    impactAnimation: 'shake',
    glowIntensity: 'drop',
    rarity: 'rare',
    headline: '📦 MAX SUPPLY DROP ACTIVE',
    idleCta: 'Tap to Activate',
    activatedTitle: 'Max Supply Drop Activated',
    activatedMessage: 'Rare rewards may be available during this event.',
    audioFallbackMs: 4600,
    vibrationPattern: [50, 32, 85, 38, 100],
  },
});
