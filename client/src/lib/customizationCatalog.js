...
export const EMBLEMS = [
  ...
  {
    id: "sigil_founding_tester",
    name: "Founding Tester Emblem",
    subtitle: "Shaped Final10 before launch",
    glyph: "🧪",
    group: "exclusive_founders",
    rarity: "exclusive",
    accent: "linear-gradient(135deg, #a855f7, #fbbf24)",
    requirement: "Complete all 7 Founding Tester missions",
    check: () => userHasExclusive("sigil_founding_tester"),
  },
  {
    id: "sigil_founding_legacy",
    name: "Founder Emblem",
    subtitle: "Legacy sealed in the Savvy Universe",
    glyph: "🏛",
    group: "exclusive_founders",
    rarity: "exclusive",
    accent: "linear-gradient(135deg, #a855f7, #fbbf24)",
    requirement: "Complete all 7 Founding Tester missions",
    check: () => userHasExclusive("sigil_founding_legacy"),
  },
  {
    id: "sigil_the_signal",
    name: "The Signal",
...
export const CALLING_CARDS = [
  ...
  {
    id: "card_founding_tester",
    name: "Founding Tester",
    tagline: "You helped shape Final10 before the world saw it",
    rarity: "exclusive",
    group: "exclusive_founders",
    stripe: "linear-gradient(90deg, #1e1b4b, #7c3aed 50%, #422006)",
    flare: "linear-gradient(90deg, transparent, rgba(251, 191, 36, 0.5), transparent)",
    requirement: "Complete all 7 Founding Tester missions",
    check: () => userHasExclusive("card_founding_tester"),
  },
  {
    id: "card_founding_beta",
    name: "Founding Beta Card",
    tagline: "One of the first 100 — forever",
    rarity: "exclusive",
    group: "exclusive_founders",
    stripe: "linear-gradient(90deg, #1e1b4b, #7c3aed 42%, #78350f)",
    flare: "linear-gradient(90deg, transparent, rgba(251, 191, 36, 0.55), rgba(192, 132, 252, 0.45), transparent)",
    requirement: "Founding Beta slot #001–#100",
  ...
  // ---------- Perk Machine drops (spin the machine to collect) ----------
  {
    id: "card_pm_signal_scout",
    name: "Signal Scout",
    tagline: "First to the drop, every time.",
    collection: "Perk Machine",
    rarity: "rare",
    stripe: "linear-gradient(90deg, #0f172a, #0e7490 45%, #082f49)",
    flare: "linear-gradient(90deg, transparent, rgba(56, 189, 248, 0.35), transparent)",
    requirement: "Spin the Savvy Perk Machine",
    check: () => bpCosmeticUnlocked("card_pm_signal_scout"),
  },
  {
    ...
    collection: "Perk Machine",
    rarity: "rare",
    stripe: "linear-gradient(90deg, #052e16, #16a34a 45%, #14532d)",
    flare: "linear-gradient(90deg, transparent, rgba(74, 222, 128, 0.35), transparent)",
    requirement: "Spin the Savvy Perk Machine",
    check: () => bpCosmeticUnlocked("card_pm_deal_runner"),
  },
  {
    ...
    collection: "Perk Machine",
    rarity: "epic",
    stripe: "linear-gradient(90deg, #2e1065, #7c3aed 45%, #1e1b4b)",
    flare: "linear-gradient(90deg, transparent, rgba(192, 132, 252, 0.42), transparent)",
    requirement: "Spin the Savvy Perk Machine",
    check: () => bpCosmeticUnlocked("card_pm_neon_operator"),
  },
  {
    ...
    collection: "Perk Machine",
    rarity: "epic",
    stripe: "linear-gradient(90deg, #422006, #f59e0b 45%, #78350f)",
    flare: "linear-gradient(90deg, transparent, rgba(251, 191, 36, 0.45), transparent)",
    requirement: "Spin the Savvy Perk Machine",
    check: () => bpCosmeticUnlocked("card_pm_gold_standard"),
  },
  {
    ...
    collection: "Perk Machine",
    rarity: "legendary",
    stripe: "linear-gradient(90deg, #450a0a, #dc2626 45%, #7c2d12)",
    flare: "linear-gradient(90deg, transparent, rgba(248, 113, 113, 0.5), rgba(251, 191, 36, 0.35), transparent)",
    requirement: "Rare Savvy Perk Machine drop",
    check: () => bpCosmeticUnlocked("card_pm_apex_closer"),
  },
  {
    ...
    collection: "Perk Machine",
    rarity: "legendary",
    stripe: "linear-gradient(90deg, #422006, #eab308 42%, #4a044e)",
    flare: "linear-gradient(90deg, transparent, rgba(253, 224, 71, 0.55), rgba(192, 132, 252, 0.4), transparent)",
    requirement: "Rare Savvy Perk Machine drop",
    check: () => bpCosmeticUnlocked("card_pm_jackpot_royalty"),
  },
];
