...
export default function ForgotPassword() {
  ...
  return (
    <div className="max-w-md mx-auto p-6">
      ...
      <p className="text-sm text-[var(--f10-text-dim)] text-center mb-6">
      ...
      {sent ? (
        ...
        <>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            <label htmlFor="forgot-email" className="block text-sm text-[var(--f10-text-dim)] mb-1">
              Email
            </label>
            <input
              id="forgot-email"
      ...
      <p className="mt-6 text-sm text-[var(--f10-text-dim)] text-center">
